...
import {EquipmentShort} from "../../../model/equipment-short";
 ...
 *
 * Combine and add additional param to equipment.
 *
...
export class EquipmentComponent implements OnInit, OnDestroy {
  ...
  //-----equipment params--------
  /** Map with additional params inside*/
  ...
  loadModel(vendor: any) {
    ...
    //load models
    this.models$ = this.http.getIdValueMap(HttpService.urlPatternEquipment + 'model/' + vendor, 'model')
      .subscribe(data => this.selectModels = data);
  }

  /** When a model selected, load all series of this model*/
  ...
  //------for one aditional param todo make multiple additional params
  ...
  /** Add param value, When both param name, and param value are valid, add them to additional equipment params*/
  addValue(event: any) {
